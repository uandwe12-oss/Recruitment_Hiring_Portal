...
const CreateUser = () => {
  ...
  const checkBackendStatus = async () => {
    try {
      const response = await fetch("https://recruitment-hiring-portal-c7rqt3y5w-uandwe12-oss-projects.vercel.app/api/users", {
        method: "HEAD",
      });
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      const response = await fetch(`https://recruitment-hiring-portal-c7rqt3y5w-uandwe12-oss-projects.vercel.app/api/users/${editingUser.username}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const handleDelete = async (username) => {
    ...
    try {
      const response = await fetch(`https://recruitment-hiring-portal-c7rqt3y5w-uandwe12-oss-projects.vercel.app/api/users/${username}`, {
        method: "DELETE",
      });
        ...
        <div className="min-h-screen bg-white/50 backdrop-blur-sm">
          ...
          <div className="flex items-center justify-center h-64">
            <div className="text-center bg-white p-8 rounded-2xl shadow-xl">
              ...
              <p className="text-gray-600 mb-4">Cannot connect to https://recruitment-hiring-portal-c7rqt3y5w-uandwe12-oss-projects.vercel.app/</p>
