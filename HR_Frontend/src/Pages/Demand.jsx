              ...
              <div className="overflow-y-auto px-6 pb-6">
                ...
                <div className="mt-6 flex justify-center gap-4 pb-2">
                  {!isAdding && formDemand?.id && (
                    <>
                      {/* View Candidates button - Admin only */}
                      {userRole === "Admin" && (
                        <button
                      ...
                      {/* View Selected button - Both Admin and Interviewer */}
                      <button
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {currentSelectedCandidates.map((candidate) => (
                      ...
                      >
                        ...
                        {/* Show latest reason/description if available - Admin only */}
                        {userRole === "Admin" && candidate.history && candidate.history.length > 0 && (
