...
const Demand = () => {
  ...
  const fetchDemands = async () => {
    try {
      const response = await fetch("https://recruitment-hiring-portal-c7rqt3y5w-uandwe12-oss-projects.vercel.app/api/demand");
  ...
  const handleDeleteDemand = async (demandId) => {
    ...
    try {
      const response = await fetch(`https://recruitment-hiring-portal-c7rqt3y5w-uandwe12-oss-projects.vercel.app/api/demand/${demandId}`, {
        method: "DELETE",
      });
  ...
  const handleSaveDemand = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `https://recruitment-hiring-portal-c7rqt3y5w-uandwe12-oss-projects.vercel.app/api/demand/${editedDemand.id}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
